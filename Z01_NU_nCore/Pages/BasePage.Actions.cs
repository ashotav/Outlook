...
namespace Z01_NU_nCore.Pages
{
    public partial class BasePage
    {
        ...
        public BasePage(WindowsDriver<WindowsElement> driver) => _driver = driver;
        //}
        ...
        public void ClickElement(WindowsElement element, string funcName)
        {
            ...
            //n screenShot.SaveAsFile($@"{OutLookPageObjectsTests.deployDir}\\{funcName}{DateTime.Now.ToString("ddMMyyyyhhmmss")}.png", OpenQA.Selenium.ScreenshotImageFormat.Png);
            Console.WriteLine($"Console after scrShot: Test:{funcName} {txt} Date: {DateTime.Now:dd-MM-yyyy HH:mm:ss.fff}");
            // n cont.TestContext.WriteLine($"Console after scrShot: Test:{funcName} {txt} Date: {DateTime.Now:dd-MM-yyyy HH:mm:ss.fff}");
